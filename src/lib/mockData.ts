...
export const MOCK_PRODUCTS = [
  // ── 1 ─ Sac Cuir Milano (Beige) ──────────────────────────────────────────
  {
    ...
    description:  "Sac à main en cuir pleine fleur d'exception, façonné en Italie. Fermeture dorée, doublure en suède. La pièce emblématique de AFEFLUXE.",
    price:        289,
    comparePrice: 349,
  ...
  // ── 11 ─ Foulard Soie Desert Rose ────────────────────────────────────────
  {
    ...
    description:  "Foulard 100% soie, imprimé floral oriental. 90×90 cm. Cadeau idéal, livré en boîte AFEFLUXE.",
    price:        89,
    comparePrice: undefined,
