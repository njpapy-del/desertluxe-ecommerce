...
const SLIDES: Record<Locale, SlideConfig[]> = {
  en: [
    ...
    { name: 'Summer Sandals',   slug: 'chaussures',   image: '/images/or25689.png',         tag: 'Summer Collection',  accent: 'Lightweight sandals · Dubai style · Comfort & elegance',            cta: 'View the sandals'     },
    ...
    { name: 'Luxury Dresses',   slug: 'robes',        image: '/images/robes de luxe.png',   tag: 'Limited Edition',    accent: 'Refined oriental cuts · Prestige occasions',                        cta: 'View the dresses'     },
  ...
  ar: [
    ...
    { name: 'صندل الصيف',     slug: 'chaussures',   image: '/images/or25689.png',         tag: 'مجموعة الصيف',    accent: 'صنادل خفيفة · أسلوب دبي · راحة وأناقة',               cta: 'عرض الصندل'         },
    ...
    { name: 'فساتين فاخرة',   slug: 'robes',        image: '/images/robes de luxe.png',   tag: 'إصدار محدود',     accent: 'تصاميم شرقية راقية · مناسبات الحفلات',                 cta: 'عرض الفساتين'       },
