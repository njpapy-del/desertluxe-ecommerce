...
const SLIDES = [
  ...
  },
  {
    name: 'Bijoux & Or',
    slug: 'bijoux',
    image: 'https://images.unsplash.com/photo-1573408301185-9519eb7db41c?w=1400&q=80&fit=crop&auto=format',
    tag: 'Or 18 carats',
    accent: 'Or jaune & or blanc · Plaqué premium',
    cta: 'Voir les bijoux',
  },
  {
    name: 'Tennis & Sport',
    ...
    tag: 'Sportswear Luxe',
    accent: 'Confort absolu · Style premium',
    cta: 'Explorer le sport',
  },
  {
    name: 'Robes de Luxe',
    slug: 'robes',
