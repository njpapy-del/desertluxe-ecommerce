...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      role: 'assistant',
      content:
        "Bonjour ! Je suis **Leila**, votre conseillère AFEFLUXE. Comment puis-je vous aider aujourd'hui ? 🌟",
      createdAt: new Date(),
    },
  ])
  ...
  const reset = () => {
    setMessages([{
      id: 'welcome',
      role: 'assistant',
      content: "Bonjour ! Je suis **Leila**, votre conseillère AFEFLUXE. Comment puis-je vous aider aujourd'hui ? 🌟",
      createdAt: new Date(),
    }])
  }
            ...
            <div className="bg-luxury-dark text-white px-5 py-4 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-cream-400 font-sans">Conseillère AFEFLUXE · IA</p>
                </div>
              </div>
              <button
                onClick={reset}
