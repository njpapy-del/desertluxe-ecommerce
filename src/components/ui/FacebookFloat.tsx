...
export default function FacebookFloat() {
  return (
    <a
      ...
      className="fixed bottom-[116px] left-5 z-50 flex items-center gap-2
                 bg-[#1877F2] text-white rounded-full shadow-lg
                 pl-2.5 pr-3 py-2 text-[11px] tracking-wide uppercase font-sans font-medium
                 hover:bg-[#0f65d8] hover:shadow-xl hover:scale-105
